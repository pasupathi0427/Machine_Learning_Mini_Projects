...
movies_data = pd.read_csv('C:/Users/Lucky_PC/Desktop/Streamlit/movies.csv')
similarity = np.load('C:/Users/Lucky_PC/Desktop/Streamlit/cosine similarity score.npy')
